...
import ManageTreatmentSlots from './Pages/Dashboard/ManageTreatmentSlots';
    ...
    <div className="max-w-7xl mx-auto px-12s">
      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<RequireAuth><Dashboard/></RequireAuth>}>
          ...
          <Route path="manageTreatmentSlots" element={<RequireAdmin><ManageTreatmentSlots></ManageTreatmentSlots></RequireAdmin>}/>
        </Route>
      </Routes>
      <ToastContainer />
    </div>
